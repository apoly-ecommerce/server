...
class CategorySubGroupPolicy
{
    ...
    /**
     * Determine whether the user can view the CategorySubGroups.
     *
     * @param App\User $user.
     * @return mixed
     */
    ...
    /**
     * Determine whether the user can create the CategorySubGroup.
     *
     * @param App\User $user
     * @return mixed
     */
    ...
    {
        return (new Authorize($user, 'update_category_sub_group', $categorySubGroup))->check();
    }
