...
trait Imageable {
    ...
    {
        return $this->morphOne(\App\Models\Image::class, 'imageable')->where('featured','!=',1);
    }
    ...
    {
        return $this->morphOne(\App\Models\Image::class, 'imageable')->where('type', 'feature');
    }
    ...
    {
        return $this->morphOne(\App\Models\Image::class, 'imageable')->where('type', 'mobile');
    }
